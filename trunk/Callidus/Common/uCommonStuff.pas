...
const
  sCALLIDUS_SYSTEM_VERSION = 'v1.11';
  ...
  sBANNERFOLDERNAME = 'banniere';
  sFULLSCREENFOLDERNAME = 'fullscreen';
  ...
  CALLIDUS_CMD_SET_RADAR_LOW_LIMIT = 'SetRdrLo';
  CALLIDUS_CMD_SET_RADAR_HIG_LIMIT = 'SetRdrHi';
  CALLIDUS_CMD_SET_RADAR_SHOW_TIME = 'SetRdrSt';
  CALLIDUS_CMD_SET_RADAR_LOWINACSP = 'SetRdrLs';
  CALLIDUS_CMD_SET_RADAR_HIGINACSP = 'SetRdrHs';
  CALLIDUS_CMD_SET_RADAR_INAC_TIME = 'SetRdrIt';
  ...
  CALLIDUS_INFO_UNISCOL = 'UniSCol';
  CALLIDUS_INFO_UNISHSZ = 'UniShSz';
  CALLIDUS_INFO_UNISPAC = 'UniSpac';
  CALLIDUS_INFO_BANNERF = 'BennerF';
  CALLIDUS_INFO_FULLPUB = 'FullPub';
